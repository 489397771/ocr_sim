...
if __name__ == '__main__':
    ...
    saver.restore(sess, os.path.join(abs_path, "models/VGGnet_fast_rcnn_iter_470000.ckpt"))
    print(' done.')
    ...
    im_names = glob.glob(os.path.join(cfg.DATA_DIR, 'demo1', '*.png')) + glob.glob(
        os.path.join(cfg.DATA_DIR, 'demo1', '*.jpg'))
